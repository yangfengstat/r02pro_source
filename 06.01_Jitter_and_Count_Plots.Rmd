...
When we want to visualize the distribution of a pair of discrete variables, another method to solve the overplotting issue is the **count plot**, which uses circles of different sizes to represent the frequency of each value pair. You can use the function `geom_count()` to generate a count plot. 
```{r}
ggplot(data = remove_missing(gm2004, 
                             vars = c("continent", "HDI_category"))) + 
